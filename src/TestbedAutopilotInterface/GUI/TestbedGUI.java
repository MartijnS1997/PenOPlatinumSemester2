...
public class TestbedGUI implements Runnable{
    ...
    private void initWindows(){
        ...
        this.getGraphics().makeMiniMap("Radar", getMonitorWidth()/4, getMonitorHeight()/3, getMonitorWidth()*3/4, getMonitorHeight()*2/3, Objects.getDroneGuiStates(), Objects.getMainDroneID(), Objects.getAirportGuiStates(), Objects.getDeliveryGuiStates());
    }
