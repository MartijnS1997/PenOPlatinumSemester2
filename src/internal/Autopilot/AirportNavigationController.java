...
//        Controller.ControlOutputs outputs = new Controller.ControlOutputs(AirportNavigationController.this.getStandardOutputs());
//
...
//     * @param previousInputs the previous inputs from the testbed
//     */
//    private void thrustControl(Controller.ControlOutputs outputs, AutopilotInputs_v2 currentInputs, AutopilotInputs_v2 previousInputs){
//        //get the parameters needed to call the cruise control
//        float referenceVelocity = this.getTurnVelocity();
//        Controller.PIDController thrustPID = this.getThrustController();
//        AirportNavigationController.this.flightCruiseControl(outputs, currentInputs, previousInputs, thrustPID, referenceVelocity);
//    }
//
//    /**
...
//     * @param previousInputs the inputs previously received from the testbed
//     */
//    private void rollControl(Controller.ControlOutputs outputs, AutopilotInputs_v2 currentInputs, AutopilotInputs_v2 previousInputs) {
...
//
//        Controller.PIDController rollController = this.getRollController();
...
//        float deltaTime = getDeltaTime(currentInputs, previousInputs);
//        Controller.PIDController rollCorrectionPID = this.getRollCorrectController();
//
//
...
//     * @param previousInputs the inputs previously received from the testbed
//     */
//    private void pitchControl(Controller.ControlOutputs outputs, AutopilotInputs_v2 currentInputs, AutopilotInputs_v2 previousInputs){
//        //get the reference value
...
//        float deltaTime = getDeltaTime(currentInputs, previousInputs);
//        //feed the results into the pid controller
//        Controller.PIDController pitchPid = this.getPitchController();
//        float pidResult = pitchPid.getPIDOutput(pitchError, deltaTime);
//        //if the pid result is positive: the set point is larger than the input -> lower the pitch (pos inclination)
//        //if the pid result is negative: the set point is smaller than the input -> increase the pitch (neg inclination)
//        float horizontalInclination = getHorizontalStable() + pidResult;
...
//     */
//    private Controller.PIDController getThrustController() {
...
//     */
//    private Controller.PIDController getRollController() {
...
//     */
//    private Controller.PIDController getPitchController() {
...
//     */
//    private Controller.PIDController getRollCorrectController(){
...
//    private final Controller.PIDController thrustController = new Controller.PIDController(THRUST_GAIN, THRUST_INTEGRAL, THRUST_DERIVATIVE);
//
//    private final static float ROLL_GAIN = 1.0f;
//    private final static float ROLL_INTEGRAL = 0.0f;
//    private final static float ROLL_DERIVATIVE = 0.5f;
//    private final Controller.PIDController bankingRollController = new Controller.PIDController(ROLL_GAIN, ROLL_INTEGRAL, ROLL_DERIVATIVE);
//
...
//    private final Controller.PIDController pitchController = new Controller.PIDController(PITCH_GAIN, PITCH_INTEGRAL, PITCH_DERIVATIVE);
//
//
...
//    private final Controller.PIDController rollCorrectController = new Controller.PIDController(ROLL_CORRECT_GAIN, ROLL_CORRECT_INTEGRAL, ROLL_CORRECT_DERIVATIVE);
//
////        @Override
