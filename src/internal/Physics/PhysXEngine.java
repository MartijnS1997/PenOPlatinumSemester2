...
//        Vector totalLift = Vector.sumVectorArray(liftVectors);
        ...
        this.getDroneChassis().netChassisForces(transformations, droneForces, state, inputs, deltaTime);
...
//        Vector velocity = state.getVelocity();
        ...
        Vector chassisMoment = this.getDroneChassis().netChassisMoment(transformations, droneForces, state);
